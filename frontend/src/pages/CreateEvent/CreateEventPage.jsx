...
export const CreateEventPage = () => {
  ...
  return (
    <>
    {/* Image taken by -  "Pixabay, Pexels [Online]. Available: https://www.pexels.com/photo/people-throwing-pins-433452/.[Accesed: June 5, 2024.] */}
      <div
        // style={{
        ...
        >
          <div class="container">
            <div class="row align-items-center">
              <div class="container-fluid p-3 mt-4 bg-white">
                <div>
                  <div>
